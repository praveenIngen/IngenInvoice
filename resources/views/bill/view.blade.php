                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="action-btn bg-primary ms-2">
                                            <a data-url="{{ route('bill.edit.debit.notes',[$debitNote->bill,$debitNote->id]) }}" data-ajax-popup="true" data-title="{{__('Edit Debit Note')}}" href="#" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}">
