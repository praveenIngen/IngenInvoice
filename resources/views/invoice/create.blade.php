...
@push('script-page')
    ...
    <script>
        ...
        $("#invoiceCreateSubmit").addClass('disabled');
        var selector = "body";
                ...
                hide: function (deleteElement) {
                        ...
                        if(totalItemDiscountPrice!=undefined && totalItemDiscountPrice>0){
                            ...
                            if(totalItemPrice!=undefined && totalItemPrice>0){
                                ...
                                $("#invoiceCreateSubmit").removeClass('disabled');
                            }else{
                                $('.subTotal').html("0.00");
 ...
 $(document).on('click', '#invoiceCreateSubmit', function (event)
   {
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'invoice','class'=>'w-100', 'class'=>'needs-validation','id'=>'invoiceFormCreate')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <div class="test ">
                                   {{__('Please add new customer. ')}}   <a href="#" data-size="lg" data-url="{{ route('customer.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Customer')}}" class="">
                                    <b>{{__('Add New Customer')}}</b></a>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            {{ Form::text('ref_number', $invoice_number, array('class' => 'form-control' ,'readonly'=>'readonly', 'placeholder'=>__('Enter Ref NUmber'))) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('sales_transaction',array('CASH' => 'CASH', 'BNKTRANSFER' => 'BANK TRANSFER','CHEQUE'=>'CHEQUE','CARD'=>'CARD','CREDIT'=>'CREDIT'),null, array('class' => 'form-control select','required'=>'required')) }}
                                    </div>
                                </div>
{{--                                <div class="col-md-6">--}}
...
{{--                                </div>--}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::number('quantity','', array('class' => 'form-control quantity','min'=>1,'required'=>'required','placeholder'=>__('Qty'),'required'=>'required')) }}
        ...
        <div class="modal-footer">
            ...
            <input type="submit" value="{{__('Create')}}" class="btn btn-primary" id="invoiceCreateSubmit">
        </div>
        {{ Form::close() }}
