                            ...
                            <div class="invoice-print">
                                ...
                                <div class="row">
                                    @if (!empty($customer->billing_name))
                                        <div class="col">
                                            <small class="font-style">
                                                <strong>{{ __('Billed Addres') }} :</strong><br>
                                    ...
                                    @if (\Utility::companyData($invoice->created_by, 'shipping_display') == 'on')
                                        <div class="col">
                                            <small>
                                                <strong>{{ __('Shipped Address') }} :</strong><br>
                                    ...
                                    <div class="col">
                                        <div class="float-end mt-3">
                                            ...
                                            {!! DNS2D::getBarcodeHTML(
                                                route('invoice.link.copy', \Illuminate\Support\Facades\Crypt::encrypt($invoice->qrCode)),
                                                'QRCODE',
                                                2,
                                                2,
                                            ) !!}
                                                ...
                                                <td>
                                                    ...
                                                    <div class="action-btn bg-danger ms-2">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-confirm="{{ __('Are You Sure?') . '|' . __('This action will delete this permanently. Do you want to continue?') }}"
