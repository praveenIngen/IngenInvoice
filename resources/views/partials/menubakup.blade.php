...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        ...
        @if (Gate::check('manage product & service') || Gate::check('manage product & service'))
            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'productservice' || Request::segment(1) == 'chart-of-account-type' ? 'active dash-trigger' : '' }}">
                <a href="#!" class="dash-link ">
                ...
                <ul class="dash-submenu">
                    ...
                    @if (Gate::check('manage constant tax') ||
                                ...
                                <li
                                    class="dash-item {{ Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' ? 'active dash-trigger' : ''}}">
                                    <a class="dash-link"
