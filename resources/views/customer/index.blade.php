                                            ...
                                            @else
                                                ...
                                                @can('delete customer')
                                                    <div class="action-btn bg-danger ms-2">
                                                        ...
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para"  data-confirm="You want to delete this customer.  Press Yes to continue or Cancel to go back" data-bs-toggle="tooltip" title="{{__('Delete')}}" ><i class="ti ti-trash text-white text-white"></i></a>
                                                        {!! Form::close() !!}
                                                    </div>
                                                @endcan
                                            @endif
