{{ Form::model($creditNote, array('route' => array('invoice.edit.credit.note',$creditNote->invoice, $creditNote->id), 'method' => 'post', 'class'=>'needs-validation', 'id'=>'creditNoteFormUpdate')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{__('Update')}}" class="btn  btn-primary" id="creditNoteUpdateSubmit">
</div>
{{ Form::close() }}
<script>
    $(function(){
 ...
 $(document).on('click', '#creditNoteUpdateSubmit', function (event)
   {
