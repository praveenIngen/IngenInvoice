{{ Form::open(array('route' => array('invoice.custom.credit.note'),'mothod'=>'post', 'class'=>'needs-validation', 'id'=>'creditNoteFormCreate')) }}
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{__('Create')}}" class="btn  btn-primary" id="creditNoteCreateSubmit">
</div>
{{ Form::close() }}
<script>
     $(function(){
 ...
 $(document).on('click', '#creditNoteCreateSubmit', function (event)
   {
       var variableName=['invoice','date','amount'];
