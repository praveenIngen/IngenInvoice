...
class Utility extends Model
{
    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            'mail_port' => 465,
            'mail_encryption' => 'ssl',
            'mail_username' => 'praveencs2015@gmail.com',
            'mail_password' => 'ntez vyuu ymkg lczr',
            'mail_from_address' => 'praveencs2015@gmail.com',
            'mail_from_name' => 'Application Mail',
...
//        return ($taxRate / 100) * (($price-$discount) * $quantity);
    ...
    {
        if ($users == 'customer') {
            $user = Customer::where('created_by','=',\Auth::user()->creatorId())->where('id','=',$id)->first();
        } else {
            $user = Vender::find($id);
        }
