...
class Customer extends Authenticatable
{
    ...
    public static function getByuerDetail($customerId)
    {
            $customersDetail=[];
            $customersData= \DB::table('customers')->select('customers.*')->where('customers.id', '=', $customerId)->first();
            $customersDetail['name']=$customersData->name;
            $customersDetail['tan']=$customersData->tax_number;
            $customersDetail['brn']=	$customersData->business_registration_number;
            $customersDetail['businessAddr']=$customersData->billing_address;
            $customersDetail['buyerType']=$customersData->buyer_type;
            $customersDetail['nic']=$customersData->nic_number;
